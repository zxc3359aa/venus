...
1. Decide whether the next slice should be real Airtable API execution after credentials are approved, live connector permission adapter for Douyin/WeChat/Qianchuan/Xingtu, OpenAI Agents SDK runner, scheduler permission/audit adapter, ecommerce permission/audit adapter, or memory write automation.
