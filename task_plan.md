...
1. Decide whether the next slice should be real Airtable write connector, live connector permission adapter for Douyin/WeChat/Qianchuan/Xingtu, OpenAI Agents SDK runner, scheduler permission/audit adapter, ecommerce permission/audit adapter, local action delivery adapters, or memory write automation.
