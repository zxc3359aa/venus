...
1. Decide whether the next slice should be real Airtable write connector, live Douyin/WeChat/Qianchuan/Xingtu permission adapter, OpenAI Agents SDK runner/evals, scheduler permission/audit adapter, ecommerce permission/audit adapter, or memory write/eval automation.
